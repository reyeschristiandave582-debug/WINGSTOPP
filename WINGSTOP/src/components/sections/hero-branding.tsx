...
const CRUMBL_URL = "https://giftclick.org/aff_c?offer_id=893&aff_id=183864&source=Wingstop";
    ...
    >
      <div className="relative inline-block animate-float will-change-transform">
            ...
            <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
              <img 
                src="https://i.imgur.com/YiVl3qR.png" 
                alt="T-Mobile $500 Gift Card" 
        ...
        <div className="relative">
            ...
            <span className="text-[#000001]">Wingstop</span>
